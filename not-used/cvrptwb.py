...
def main():
    ...
    if solution:
            ...
            # Génération de la visualisation interactive (fichier HTML)
            generate_visualization(solution, data, manager, routing, output_filename="solution_visualization.html")
